...
export const metadata: Metadata = {
  ...
  title: "Pedro Novaes | Call Diagnóstica Gratuita",
  description:
    "Descubra em 45 minutos por que o seu negócio digital não escala. Saia com um plano claro para mudar isso essa semana.",
