...
const WA_URL =
  "https://wa.me/4748199443?text=Hi+Pedro%2C+I+filled+out+the+form+and+want+to+schedule+my+strategic+call%21";
  ...
  return (
    ...
    >
      ...
      >
        ...
        Talk to Pedro on WhatsApp
      </a>
      <p className="mt-4 text-[13px] text-white/30">
        Pedro Novaes will reach out within 2h · No commitment
      </p>
      <p className="mt-2 text-[13px] text-white/25">
        Redirecting automatically in <strong>{secs}</strong>s
      </p>
    </motion.div>
  );
}
