...
const WA_URL =
  "https://wa.me/4748199443?text=Oi+Pedro%2C+preenchi+o+formul%C3%A1rio+e+quero+agendar+minha+call+estrat%C3%A9gica%21";
  ...
  return (
    ...
    >
      ...
      <p className="mt-4 text-[13px] text-white/30">
        Pedro Novaes vai te chamar em até 2h · Sem compromisso
      </p>
