...
const CONTEXT_ITEMS = ["📅 7 dias de mentoria", "🚫 Sem experiência anterior", "✅ Resultado consistente"];
      ...
      <div className="mx-auto grid max-w-(--container-w) grid-cols-1 items-center gap-16 md:grid-cols-2">
        <div>
          ...
          <Reveal delay={1}>
            ...
            >
              <span className="text-white/70">O Arthur chegou zerado.</span>
              <br />
          ...
          <Reveal delay={3}>
            <p className="text-body-color" style={{ fontSize: "var(--fs-body)", lineHeight: "var(--lh-body)" }}>
              O Arthur entrou sem nenhuma experiência em tráfego pago e sem resultado anterior
              nenhum. Foram 7 dias de acompanhamento individual: análise de campanha ao vivo,
              correção da estrutura e ajuste de copy. No fim da primeira semana, ele batia{" "}
              <strong className="text-white">R$ 1.000 de faturamento por dia</strong>, de forma
              consistente, não num pico de sorte.
            </p>
          </Reveal>
          <Reveal delay={4}>
            ...
            <div className="mx-auto w-full max-w-[340px]">
              <div className="flex items-center justify-center overflow-hidden rounded-md border border-blue/20 bg-[#0b0b10]">
                <Image
                  ...
                  alt="Acompanhamento individual ao vivo com mentorado"
                  width={960}
                  height={1280}
              ...
              <p className="mt-2.5 text-center text-[13px] text-white/45">
                Acompanhamento individual ao vivo: construção da operação em tempo real
              </p>
            </div>
          </Reveal>
        </div>
